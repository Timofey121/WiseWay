...
| Q-045 · SRCH-23, NFR-02/03/04/06 · S/A/E | NOT_RUN | — | NOT_RUN | NOT_RUN | На macOS: 50 аккаунтов, 12 500 запросов, 3200 добавленных файлов/1000 audit events; p95 точного поиска 523,892 мс, широкого 503,669 мс. Отдельный общий аккаунт с 50 сессиями: p95 типового поиска 1969,495 мс. Проверены реальные совпадения и содержимое ответов, ошибок нет. Linux и полный комплект совместной приёмки ещё не проверены; частичные замеры не закрывают весь Q-ID |

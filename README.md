...
[Замеры и план роста до 100 тысяч–1 миллиона файлов](docs/performance.md): оптимизации поиска, индексатора, очереди и журнала, воспроизводимые стенды и текущие ограничения.

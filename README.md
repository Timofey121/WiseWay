...
[Замеры и проектирование под 200 млн файлов](docs/performance.md): воспроизводимые стенды, реализованные оптимизации и работа, необходимая для промышленного архива.

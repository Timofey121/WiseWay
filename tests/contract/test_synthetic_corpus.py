...
class NegativeFixtureTests(CorpusFixtureMixin, unittest.TestCase):
    ...
    def test_run_checks_reports_the_fixture_checks(self):
        ...
        self.assertIn("FIX-SCN-001", passed)
        self.assertIn("FIX-SCN-002", passed)
        self.assertIn("FIX-SCN-003", passed)
        self.assertIn("FIX-QR-001", passed)
        self.assertIn("FIX-QR-002", passed)
        self.assertIn("FIX-QR-003", passed)
        self.assertIn("FIX-AUDIT-001", passed)
        self.assertIn("FIX-AUDIT-002", passed)
        self.assertIn("FIX-AUDIT-003", passed)
        self.assertEqual(142, report.fixtures_validated)
        ...
        self.assertEqual(19, report.lifecycle_timeline)
        self.assertEqual(16, report.lifecycle_failures)
        ...
        self.assertEqual(6, report.preview_scenarios)
        self.assertEqual(134, report.preview_rows)
        ...
        self.assertEqual(12, report.scenario_scenarios)
        self.assertEqual(4, report.scenario_replays)
        self.assertEqual(9, report.scenario_containment)
        self.assertEqual(18, report.scenario_audit)
        self.assertEqual(23, report.scenario_mutations)
        self.assertEqual(41, report.scenario_links)
        self.assertEqual(2, report.quarantine_records)
        self.assertEqual(11, report.quarantine_scenarios)
        self.assertEqual(2, report.quarantine_replays)
        self.assertEqual(2, report.quarantine_audit)
        self.assertEqual(22, report.quarantine_mutations)
        self.assertEqual(21, report.quarantine_links)
        self.assertEqual(323, report.audit_events)
        self.assertEqual(17, report.audit_queries)
        self.assertEqual(4, report.audit_actor_pages)
        self.assertEqual(4, report.audit_updates)
        self.assertEqual(24, report.audit_mutations)
        self.assertEqual(17, report.audit_links)

...
Результаты ревью, исправления и незакрытые ограничения: [протокол проверки](backend/VALIDATION.md). Стресс-скрипт возвращает ненулевой код при нарушении SLA; последний p95 типового поиска при 50 клиентах — 2,23 с при цели 2 с.
